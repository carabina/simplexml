...
Pod::Spec.new do |s|
  s.name             = 'SimpleXML'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SimpleXML.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Dylan Neild/SimpleXML'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Dylan Neild' => 'dylan@codeandstrings.com' }
  s.source           = { :git => 'https://github.com/Dylan Neild/SimpleXML.git', :tag => s.version.to_s }
